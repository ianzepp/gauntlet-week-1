...
fn normalize_hex_color_normalizes_valid_inputs() {
    assert_eq!(normalize_hex_color(Some("#ABC"), "#000000"), "#aabbcc");
    assert_eq!(normalize_hex_color(Some("#A1B2C3"), "#000000"), "#a1b2c3");
}

#[test]
fn normalize_hex_color_falls_back_for_invalid_inputs() {
    assert_eq!(normalize_hex_color(Some("blue"), "#ff0000"), "#ff0000");
